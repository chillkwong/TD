...
return [
	...
	'shapePara5' => 'Marquise diamond is elongated with reference to the ship to cut out, it is now one of the most fashionable cut, because the shape of the diamond is very precious and rare, this style of diamond color and clarity requirements are very high, although Marquise diamond cut round diamonds similar, but the design of the ship to the highest carat weight, so the diamond look bigger in appearance, while flawed diamonds in the shape Marquise also glance.',
	'OVAL CUT' => 'OVAL CUT',
	'shapePara6' => 'If you want to find more special than circular, elliptical would be a good choice, oval diamonds are also very popular because a similar oval and round, and oval-shaped diamond elongated design, so that the wearer looks more elegant and more slender fingers.',
	'PEAR SHAPE' => 'PEAR SHAPE',
	'shapePara7' => 'Pear-shaped diamond style is relatively rare, single tip with a circular cutting edge, like the shape of a drop of water, and therefore also known as teardrop-shaped, and round, like, 58 surface design, visual brightness and round shape similar, but more impressive than round.',
	'PRINCESS CUT' => 'PRINCESS CUT',
	'shapePara8' => 'Is the square princess cut diamond Fu system, this diamond shape is very suitable as an engagement ring, beautiful princess cut diamond engagement rings make look more attractive and exotic, Princess decided to pay attention to this diamond shape is flawed relatively easy to accept, and to ensure the protection of the wearer’s finger design, because the princess was shaped, pointed corners.',
	'RADIANT CUT' => 'RADIANT CUT',
	'shapePara9' => 'Well-shaped diamond mine and was broken Fu system, a collection of elegant and stylish rectangular and rectangular and round brilliance from the first shape, the cut is circular and includes Emerald cutting technology, fashionable and first in 1977.',
