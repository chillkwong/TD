<footer class="footer">
	  <div class="container">
	    ...
	    <div class="content has-text-centered">
	     ...
	     <hr>
	      <p>
	        <a class="icon" href="https://facebook.com/tingdiamonds">
	          <i class="fa fa-facebook"></i>
	        </a>
	        <a class="icon" href="https://plus.google.com/+TingdiamondHk/">
	          <i class="fa fa-google"></i>
	        </a>
	        <a class="icon" href="https://twitter.com/TingDiamond">
	          <i class="fa fa-twitter"></i>
	        </a>
	        <a class="icon" href="https://www.youtube.com/channel/UCaNsACwMjz9t9evpaSkHpGg">
